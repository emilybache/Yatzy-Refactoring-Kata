...
public class ScoreHelperTest {
    ...
    public void throws_if_number_of_dice_is_different_of_5() {
        ...
        ScoreHelper.countNumberOfDiceForEachValue(dices);
    }

    @Test(expected = IllegalArgumentException.class)
    public void throws_if_dices_is_null() {
        ScoreHelper.countNumberOfDiceForEachValue(null);
    }
    @Test
    public void count_with_one_value(){
        Map<Dice, Long> counts = ScoreHelper.countNumberOfDiceForEachValue(TestHelper.getDices(1,1,1,1,1));
    ...
    public void count_with_two_values(){
        Map<Dice, Long> counts = ScoreHelper.countNumberOfDiceForEachValue(TestHelper.getDices(1,1,1,2,2));
    ...
    public void count_with_three_values(){
        Map<Dice, Long> counts = ScoreHelper.countNumberOfDiceForEachValue(TestHelper.getDices(3,4,4,5,5));
    ...
    public void count_with_four_values(){
        Map<Dice, Long> counts = ScoreHelper.countNumberOfDiceForEachValue(TestHelper.getDices(3,4,4,5,2));
    ...
    public void count_with_five_values(){
        Map<Dice, Long> counts = ScoreHelper.countNumberOfDiceForEachValue(TestHelper.getDices(3,1,4,5,2));
